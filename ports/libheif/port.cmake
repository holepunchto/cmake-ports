...
declare_port(
  ...
  heif
  BYPRODUCTS lib/libheif.$<IF:${WIN32},lib,a>
  DEPENDS
    dav1d
    de265
  PATCHES
  ...
  ARGS
    ...
    "-DDAV1D_LIBRARY=${dav1d_PREFIX}/lib/libdav1d.$<IF:${WIN32},lib,a>"

    "-DWITH_LIBDE265=ON"
    "-DLIBDE265_INCLUDE_DIR=${de265_PREFIX}/include"
    "-DLIBDE265_LIBRARY=${de265_PREFIX}/lib/libde265.$<IF:${WIN32},lib,a>"
...
set_target_properties(
  heif
  PROPERTIES
  IMPORTED_LOCATION "${heif_PREFIX}/lib/libheif.$<IF:${WIN32},lib,a>"
)
